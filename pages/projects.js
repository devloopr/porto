            ...
            <div class="flex justify-center mt-24">
                ...
                <div class="lg:w-1/3 sm:w-1/2 p-4">
                        ...
                        <div class="px-8 py-10 relative z-10 w-full border-4 border-primary bg-white dark:bg-secondary opacity-0 hover:opacity-100">
                            ...
                            <a class="mt-3 text-primary inline-flex items-center" href="/images/oppdatert-cv.pdf" download>Klikk for å laste ned</a>
                        </div>
                        </div>
                    </div>
