                ...
                <div className="lg:px-4 lg:mt-12 ">
                    ...
                    <div className="mt-6 text-zinc-700 dark:text-fourth">
                        <p className="mb-4">
                            ...
                            Denne siden er enkel og tydelig, målet mitt er å skaffe meg jobb så fort som mulig.
                        </p>
                    </div>
                </div>
                <div className="flex-shrink-0 lg:mt-12 lg:px-4 mb-10">
                <img alt="Thumbnail erik" className="object-cover mx-auto rounded-3xl"
                            src="/images/jenteneogfoss.JPG" height="400" width="400" alt="bilde av meg selv" priority="{true}"/>
                </div>
            </div>
        </div>
